---
name: cmux
description: A native Ghostty-powered terminal with vertical workspaces, split panes, agent notifications, an embedded browser and a programmable socket API.
