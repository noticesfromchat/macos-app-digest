---
name: Recordly
description: Record the screen and let it handle the zooming and cursor-smoothing that normally costs you an evening in an editor, then export to MP4 or GIF.
