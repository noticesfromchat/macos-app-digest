...
export const siteCopy = {
  ...
  "home.titleTagline": "Curated Mac Apps for Experienced Users",
  ...
  "site.description": "App Waypoint is a curated weekly guide to exceptional Mac apps, productivity tools, automation utilities, AI software and worthwhile reading.",
  ...
  "explore.dek": "Hand-picked Mac apps from every issue, browsable by category, collection or tag. Apps selected and added every Friday.",
  "explore.metaDescription": "Browse every Mac app App Waypoint has recommended, by category, collection or tag, with the full catalog filterable and sortable on one page.",
