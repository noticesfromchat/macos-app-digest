...
- **Note Sand** (#eadfcd): the callout background tone.
- **Note Ink** (#31485d): the supporting text tone on note surfaces.
...
- **Night Note** (#0c2137): the dark callout background.
- **Night Note Ink** (#c1cbd4): the dark callout foreground.
- **Night Header Fog** (rgba(4, 20, 38, 0.96)): the dark sticky header.

**The Beacon Rule.** Blue is reserved for actions, links, focus, and active states. It should not become page chrome or decorative noise.
...
### Cards
Cards are the primary container language for apps, readings, callouts, and archive entries.
