...
- **Opening gap:** the breadcrumb sits 16px above the icon/title lockup, matching the 16px step from that lockup to the dek. This is scoped to app detail pages because the lockup is taller than a text-only page title.
